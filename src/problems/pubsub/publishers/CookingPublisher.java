...
public class CookingPublisher implements Publisher {
    ...
    public void subscribe(Subscriber subscriber) {
        ...
        System.out.printf("User %s just subscribed to COOKING!. Subscribers count now %s\n",
    ...
    public void unsubscribe(Subscriber subscriber) {
        ...
        System.out.printf("User %s unsubscribed to COOKING :(((. Subscribers count now %s\n",
                subscriber.getEmail(), subscribers.size());
    }

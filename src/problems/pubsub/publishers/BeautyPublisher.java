...
public class BeautyPublisher implements Publisher {
    ...
    public void subscribe(Subscriber subscriber) {
        ...
        System.out.printf("User %s just subscribed to BEAUTY!. Subscribers count now %s\n",
    ...
    public void unsubscribe(Subscriber subscriber) {
        ...
        System.out.printf("User %s unsubscribed to BEAUTY :(((. Subscribers count now %s\n",
                subscriber.getEmail(), subscribers.size());
    }
